...
https://githucom/victorca25/BasicSR/blob/master/codes/models/modules/architectures/RRDBNet_arch.py
"""
import math
import torch
...
"""
block.py
https://githucom/victorca25/BasicSR/blob/c594cada9422f6f3447fbeb2b2e21e4407ab1188/codes/models/modules/architectures/block.py
"""
...
# TODO: Not used:
# https://githucom/github-pengge/PyTorch-progressive_growing_of_gans/blob/master/models/base_model.py
...
class SelfAttentionBlock(pl.LightningModule):
    ...
    def __init__(
        ...
        if self.max_pool:
            ...
            # self.upsample_o = Upsample(scale_factor=self.poolsize, mode='bilinear', align_corners=False)
...
class RRDBNet(nn.Module):
    def __init__(
        ...
        # outact = act(finalact) if finalact is not None else None
        if finalact == "None":
            outact = None
        else:
            outact = act(finalact)
